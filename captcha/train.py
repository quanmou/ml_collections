...
# 在安装了CUDA的环境下，可以指定用哪块显卡来运行程序
os.environ['CUDA_VISIBLE_DEVICES'] = '0'

cwd = os.getcwd()

flags = tf.app.flags
flags.DEFINE_string('images_path', cwd + "/datasets/images/", 'Path to training images.')
flags.DEFINE_string('model_output_path', cwd + "/model/", 'Path to model checkpoint.')
flags.DEFINE_string('gpu_list', '0, 1, 2, 3, 4, 5, 6, 7', 'gpu to be used')
FLAGS = flags.FLAGS
